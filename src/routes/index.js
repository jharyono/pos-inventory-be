...
const ControlDataController = require('../controllers/controldata.controller');
...
module.exports = (app) => {
  ...
  // Router for ControlData
  app.get('/controldata', ControlDataController.get);
  app.put('/controldata/:controldataId', ControlDataController.put);
  app.post('/controldata', ControlDataController.post);
  app.delete('/controldata/:controldataId', ControlDataController.delete);
};
